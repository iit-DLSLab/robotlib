 ...
 */
TEST(ArmUnitTests, jointToParentName)
{
     /**
      * @test Get the parents of the two arm joints and check their names
      */
     {
          auto dummy_robot = dummy_robot_creator.createDummyRobot(components_names);
 ...
 */
TEST(ArmUnitTests, jointToChildName)
{
     /**
      * @test Get the child of the two arm joints and check their names
      */
     {
          auto dummy_robot = dummy_robot_creator.createDummyRobot(components_names);
          ...
          for (auto arm : *(dummy_robot->getArms()))
          {
               for (auto joint : *(arm->getJoints()))
               {
                    EXPECT_EQ(arm->jointToChildName(joint), components_names.at(5+i));
                    i++;
               }
          }
     }
 ...
 */
TEST(ArmUnitTests, linkToParentName)
{
     /**
      * @test Get the parents of the two arm links and check their names
      */
     {
          auto dummy_robot = dummy_robot_creator.createDummyRobot(components_names);
          ...
          for (auto arm : *(dummy_robot->getArms()))
          {
               for (auto link : *(arm->getLinks()))
               {
                    EXPECT_EQ(arm->linkToParentName(link), components_names.at(3+i));
                    i++;
               }
          }
     }
 ...
 */
TEST(ArmUnitTests, linkToChildName)
{
     /**
      * @test Get the child of the two arm links and check their names
      */
     {
          auto dummy_robot = dummy_robot_creator.createDummyRobot(components_names);
          ...
          for (auto arm : *(dummy_robot->getArms()))
          {
               for (auto link : *(arm->getLinks()))
               {
                    if((link->getName()).compare(components_names.at(6)) != 0)
                         EXPECT_EQ(arm->linkToChildName(link), components_names.at(4));
                    else
