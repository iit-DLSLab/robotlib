...
{
    /// Ground truth
    std::array<std::string, 4> hyq_legs{{std::string{"LF"},
                                         std::string{"RF"},
                                         std::string{"LH"},
                                         std::string{"RH"}}};

    /// HyQ
    auto hyq = dls::robotlib::RobotFactory::openRobot("hyq");
...
{
    /// Ground truth
    std::array<std::string, 4> hyq_leg_data_map_pair{{std::string{"LF"},
                                                      std::string{"RF"},
                                                      std::string{"LH"},
                                                      std::string{"RH"}}};
...
{
    /// Ground truth
    std::array<std::pair<std::string, std::string>, 8> hyq_link_data_map_pair{{{std::string{"LF"}, std::string{"Upper leg"}},
...
{
    /// Ground truth
    std::array<std::pair<std::string, std::string>, 12> hyq_joint_data_map_pair{{{std::string{"LF"}, std::string{"HAA"}},
