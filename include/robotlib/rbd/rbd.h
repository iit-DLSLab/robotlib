 ...
 */
/* } CPYHDR */
#ifndef _ROBOTLIB_RBD_RBD_HPP_
#define _ROBOTLIB_RBD_RBD_HPP_
 ...
 *
 * In other words, the primary target of the \c dls_rbd library is not to
