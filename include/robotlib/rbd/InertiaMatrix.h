...
#ifndef _ROBOTLIB_RBD_INERTIA_MATRIX_HPP_
#define _ROBOTLIB_RBD_INERTIA_MATRIX_HPP_
...
//    block33(AX,AX) = other.block<3,3>(AX,AX);
    block33(AX,AX) = other.block(AX,AX,3,3); //WARNING THIS IS DYNAMIC
...
#endif // _ROBOTLIB_RBD_INERTIA_MATRIX_HPP_
