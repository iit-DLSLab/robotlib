#ifndef _ROBOTLIB_BASE_INVERSE_KINEMATICS_HPP_
#define _ROBOTLIB_BASE_INVERSE_KINEMATICS_HPP_
...
using FootAccelerations = LegDataMap<dls::rbd::Vector3d>;

using FootPosition      = dls::rbd::Vector3d;
using FootVelocity      = dls::rbd::Vector3d;
using FootAcceleration  = dls::rbd::Vector3d;
using LegJointState     = dls::rbd::Vector3d;
...
public:
	 ...
	 */
	virtual void setKinematicLimits
	(
...
#endif // _ROBOTLIB_BASE_INVERSE_KINEMATICS_HPP_
