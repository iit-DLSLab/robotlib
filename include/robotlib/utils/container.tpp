...
namespace robotlib
{
	...
	template <class Data, unsigned int Length>
	IteratorContainer<Data> Container<Data, Length>::end() { return &data_[Length]; }
	...
	template <class Data, unsigned int Length>
	const std::shared_ptr<Data>& Container<Data, Length>::at(unsigned int idx) const { return data_[idx]; };
