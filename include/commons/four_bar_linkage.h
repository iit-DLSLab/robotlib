#ifndef _ROBOTLIB_COMMONS_FOUR_BAR_LINKAGE_HPP_
#define _ROBOTLIB_COMMONS_FOUR_BAR_LINKAGE_HPP_
...
/**
 * Geometry of the four-bar linkage used in some of dls DLS lab robots
 */
struct FBLStatus
{
    /**
     * The status angle, as in the mechanism documentation within the dls-DLS lab.
...
#endif // _ROBOTLIB_COMMONS_FOUR_BAR_LINKAGE_HPP_
