...
dls::dog::HyQ::Jacobians::Jacobians
...
void dls::dog::HyQ::Jacobians::updateParameters() {
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_foot::Type_fr_trunk_J_LF_foot(const Params_lengths& _lengths_values)
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_foot& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_foot::update(const JointState& jState) {
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_foot::Type_fr_trunk_J_RF_foot(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_foot& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_foot::update(const JointState& jState) {
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_foot::Type_fr_trunk_J_LH_foot(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = - 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_foot& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_foot::update(const JointState& jState) {
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_foot::Type_fr_trunk_J_RH_foot(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_foot& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_foot::update(const JointState& jState) {
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_shin::Type_fr_trunk_J_LF_shin(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = - 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_shin& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LF_shin::update(const JointState& jState) {
    static double sin__q_LF_HAA__;
    static double sin__q_LF_HFE__;
    static double sin__q_LF_KFE__;
    static double cos__q_LF_HAA__;
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_shin::Type_fr_trunk_J_RF_shin(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_shin& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RF_shin::update(const JointState& jState) {
    static double sin__q_RF_HAA__;
    static double sin__q_RF_HFE__;
    static double sin__q_RF_KFE__;
    static double cos__q_RF_HAA__;
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_shin::Type_fr_trunk_J_LH_shin(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = - 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_shin& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_LH_shin::update(const JointState& jState) {
    static double sin__q_LH_HAA__;
    static double sin__q_LH_HFE__;
    static double sin__q_LH_KFE__;
    static double cos__q_LH_HAA__;
...
dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_shin::Type_fr_trunk_J_RH_shin(const Params_lengths& _lengths_values)
    : lengths_values(& _lengths_values)
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0;
...
const dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_shin& dls::dog::HyQ::Jacobians::Type_fr_trunk_J_RH_shin::update(const JointState& jState) {
    static double sin__q_RH_HAA__;
    static double sin__q_RH_HFE__;
    static double sin__q_RH_KFE__;
    static double cos__q_RH_HAA__;
