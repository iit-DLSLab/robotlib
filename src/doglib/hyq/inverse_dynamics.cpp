...
dls::dog::HyQ::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
dls::dog::HyQ::dyn::InverseDynamics::Velocity dls::dog::HyQ::dyn::InverseDynamics::getLinkVelocity(const JointState &q,
                                                                                         const JointState &qd,
...
dls::dog::HyQ::dyn::InverseDynamics::Acceleration dls::dog::HyQ::dyn::InverseDynamics::getLinkAcceleration(const JointState &q,
                                                                                                 const JointState &qd,
                                                                                                 const JointState &qdd,
                                                                                                 const Acceleration &gravity_acceleration,
                                                                                                 const Velocity &trunk_velocity,
...
void dls::dog::HyQ::dyn::InverseDynamics::propagateVelAcc(
...
void dls::dog::HyQ::dyn::InverseDynamics::id(
...
void dls::dog::HyQ::dyn::InverseDynamics::G_terms_fully_actuated(
...
void dls::dog::HyQ::dyn::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void dls::dog::HyQ::dyn::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
        ...
        const JointState& qd, const JointState& qdd, const ExtForces& fext)
{
    ...
    LF_hipassembly_a = ((xm->fr_LF_hipassembly_X_fr_trunk) * trunk_a) + (spareMx.col(dls::rbd::AZ) * qd(LF_HAA));
    LF_hipassembly_a(dls::rbd::AZ) += qdd(LF_HAA);
    ...
    RF_hipassembly_a = ((xm->fr_RF_hipassembly_X_fr_trunk) * trunk_a) + (spareMx.col(dls::rbd::AZ) * qd(RF_HAA));
    RF_hipassembly_a(dls::rbd::AZ) += qdd(RF_HAA);
    ...
    LH_hipassembly_a = ((xm->fr_LH_hipassembly_X_fr_trunk) * trunk_a) + (spareMx.col(dls::rbd::AZ) * qd(LH_HAA));
    LH_hipassembly_a(dls::rbd::AZ) += qdd(LH_HAA);
    ...
    RH_hipassembly_a = ((xm->fr_RH_hipassembly_X_fr_trunk) * trunk_a) + (spareMx.col(dls::rbd::AZ) * qd(RH_HAA));
    RH_hipassembly_a(dls::rbd::AZ) += qdd(RH_HAA);
...
void dls::dog::HyQ::dyn::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'RH_lowerleg'
