...
dls::dog::HyQReal::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const dls::dog::HyQReal::dyn::JSIM& dls::dog::HyQReal::dyn::JSIM::update(const JointState& state) {
    ...
    // Link RH_lowerleg:
    dls::rbd::transformInertia(RH_lowerleg_Ic, frcTransf -> fr_RH_upperleg_X_fr_RH_lowerleg, Ic_spare);
    RH_upperleg_Ic += Ic_spare;

    Fcol(RH_KFE) = RH_lowerleg_Ic.col(AZ);
    ...
    // Link RH_upperleg:
    dls::rbd::transformInertia(RH_upperleg_Ic, frcTransf -> fr_RH_hipassembly_X_fr_RH_upperleg, Ic_spare);
    RH_hipassembly_Ic += Ic_spare;

    Fcol(RH_HFE) = RH_upperleg_Ic.col(AZ);
    ...
    // Link RH_hipassembly:
    dls::rbd::transformInertia(RH_hipassembly_Ic, frcTransf -> fr_trunk_X_fr_RH_hipassembly, Ic_spare);
    trunk_Ic += Ic_spare;

    Fcol(RH_HAA) = RH_hipassembly_Ic.col(AZ);
    DATA(RH_HAA+6, RH_HAA+6) = Fcol(RH_HAA)(AZ);

    Fcol(RH_HAA) = frcTransf -> fr_trunk_X_fr_RH_hipassembly * Fcol(RH_HAA);

    // Link LH_lowerleg:
    dls::rbd::transformInertia(LH_lowerleg_Ic, frcTransf -> fr_LH_upperleg_X_fr_LH_lowerleg, Ic_spare);
    LH_upperleg_Ic += Ic_spare;

    Fcol(LH_KFE) = LH_lowerleg_Ic.col(AZ);
    ...
    // Link LH_upperleg:
    dls::rbd::transformInertia(LH_upperleg_Ic, frcTransf -> fr_LH_hipassembly_X_fr_LH_upperleg, Ic_spare);
    LH_hipassembly_Ic += Ic_spare;

    Fcol(LH_HFE) = LH_upperleg_Ic.col(AZ);
    ...
    // Link LH_hipassembly:
    dls::rbd::transformInertia(LH_hipassembly_Ic, frcTransf -> fr_trunk_X_fr_LH_hipassembly, Ic_spare);
    trunk_Ic += Ic_spare;

    Fcol(LH_HAA) = LH_hipassembly_Ic.col(AZ);
    DATA(LH_HAA+6, LH_HAA+6) = Fcol(LH_HAA)(AZ);

    Fcol(LH_HAA) = frcTransf -> fr_trunk_X_fr_LH_hipassembly * Fcol(LH_HAA);

    // Link RF_lowerleg:
    dls::rbd::transformInertia(RF_lowerleg_Ic, frcTransf -> fr_RF_upperleg_X_fr_RF_lowerleg, Ic_spare);
    RF_upperleg_Ic += Ic_spare;

    Fcol(RF_KFE) = RF_lowerleg_Ic.col(AZ);
    ...
    // Link RF_upperleg:
    dls::rbd::transformInertia(RF_upperleg_Ic, frcTransf -> fr_RF_hipassembly_X_fr_RF_upperleg, Ic_spare);
    RF_hipassembly_Ic += Ic_spare;

    Fcol(RF_HFE) = RF_upperleg_Ic.col(AZ);
    ...
    // Link RF_hipassembly:
    dls::rbd::transformInertia(RF_hipassembly_Ic, frcTransf -> fr_trunk_X_fr_RF_hipassembly, Ic_spare);
    trunk_Ic += Ic_spare;

    Fcol(RF_HAA) = RF_hipassembly_Ic.col(AZ);
    DATA(RF_HAA+6, RF_HAA+6) = Fcol(RF_HAA)(AZ);

    Fcol(RF_HAA) = frcTransf -> fr_trunk_X_fr_RF_hipassembly * Fcol(RF_HAA);

    // Link LF_lowerleg:
    dls::rbd::transformInertia(LF_lowerleg_Ic, frcTransf -> fr_LF_upperleg_X_fr_LF_lowerleg, Ic_spare);
    LF_upperleg_Ic += Ic_spare;

    Fcol(LF_KFE) = LF_lowerleg_Ic.col(AZ);
    ...
    // Link LF_upperleg:
    dls::rbd::transformInertia(LF_upperleg_Ic, frcTransf -> fr_LF_hipassembly_X_fr_LF_upperleg, Ic_spare);
    LF_hipassembly_Ic += Ic_spare;

    Fcol(LF_HFE) = LF_upperleg_Ic.col(AZ);
    ...
    // Link LF_hipassembly:
    dls::rbd::transformInertia(LF_hipassembly_Ic, frcTransf -> fr_trunk_X_fr_LF_hipassembly, Ic_spare);
    trunk_Ic += Ic_spare;

    Fcol(LF_HAA) = LF_hipassembly_Ic.col(AZ);
...
void dls::dog::HyQReal::dyn::JSIM::computeL() {
...
void dls::dog::HyQReal::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void dls::dog::HyQReal::dyn::JSIM::computeLInverse() {
