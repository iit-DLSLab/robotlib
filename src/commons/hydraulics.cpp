...
void dls::hydr::PortToVoltageSign::set(ValvePort::Port port, VoltageSign sign)
{
    map[port] = sign;
...
void dls::hydr::feedback_linearization_motor(
...
void dls::hydr::feedback_linearization_cylinder(
    const PipelineProperties& pipeline,
