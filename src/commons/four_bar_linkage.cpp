...
dls::commons::FBLStatus::FBLStatus(const FBLConsts& p) : theta(0.0), extension(0.0), jac(0.0), consts(p)
{
...
void dls::commons::FBLStatus::updateGeometry()
{
...
void dls::commons::FBLStatus::setExtension(double cyl)
{
    extension = cyl;
...
void dls::commons::FBLStatus::computeNumericJacobian(double q)
{
