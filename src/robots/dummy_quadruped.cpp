...
namespace robotlib
{
	...
	public:
        ...
        void inverseDynamics(Eigen::Matrix<double, 6, 1> &wrench_base,
                                    ...
                                    const Eigen::Matrix<double, 6, 1> &robot_velocity = Eigen::Matrix<double, 6, 1>::Zero(),
                                    const Eigen::Matrix<double, 6, 1> &robot_acceleration = Eigen::Matrix<double, 6, 1>::Zero()) const override		   ///output
		{
        ...
        */
		...
		void setTrunkMass(const double& trunk_mass) const override {std::cout << "TODO\n";};
